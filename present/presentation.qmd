---
title: "ETC5543 - A new way of viewing maps - hexmap"
...
-   <div>
    ...
    ![](images/ozhexmap-fix.gif){fig-align="center"}
...
## Other Examples {.smaller .scrollable}
...
## Ways to refine {.smaller .scrollable}
...
-   Functions from [`cartogram`](https://github.com/sjewo/cartogram) to distort the original data according to a specific variable set by users.
    ...
    -   See example illustration on **Appendix** ("cartogram distortion")
        ...
        ```{r}
            # Distorting regions based on a weight variable via 
            ## multiple times of iterations for convergence
...
- Notes: A reverse computation process is applied here.
:::
:::
:::
...
-   Sample - [2022 AU Election Data](https://results.aec.gov.au/27966/Website/HouseDownloadsMenu-27966-Csv.htm) data
...
-   See reproducible codes on **Appendix** ("Step 3 example codes")
    -   Some tests on using mixture of grids.
    -   Test on state-level plotting.
:::
...
::: incremental
-   Improve the calculation accuracy on the width of a hexagon \[Currently is an "**Approximation**"\].
:::
...
-   Codes for reproducing example plots in previous section "Step 3"
...
## Test for mixture of hex-grid {.smaller .scrollable}

::: panel-tabset
## Mixture one

![](images/step3-mix1.png){fig-align="center"}
...
![](images/step3-mix2.png){fig-align="center"}
...
## Test on state-level {.smaller .scrollable}

![](images/example3-au.png){fig-align="center"}
