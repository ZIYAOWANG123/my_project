...
## Introduction {background-image="images/bg.jpg" background-opacity="0.5"}

![](images/auselection-2022.gif){fig-align="center" width="434" height="402"}
...
## Purpose of [`Hexmap`](https://github.com/numbats/hexmap) package: {background-image="images/bg.jpg" background-opacity="0.5"}
...
## Motivation {.smaller .scrollable background-image="images/bg.jpg" background-opacity="0.5"}
...
::: columns
::: {.column width="50%"}
![1st - Spread hex_grid onto regions](images/mot_2.png){alt="1st - Spread hex_grid onto regions" fig-align="center" width="328"}
:::

::: {.column width="50%"}
![2nd - Group statistical values by states](images/mot_3.png){alt="2nd - Group statistical values by states" fig-align="center" width="306" height="310"}
:::
:::
...
::: columns
::: {.column width="50%"}
![Example of information in state level](images/mot_4.png){alt="Example of information in state level" fig-align="center" width="347" height="248"}
:::

::: {.column width="50%"}
![Final Result](images/paste-592B5C3C.png){fig-align="center" width="382"}
:::
:::
...
## Hexmap Tour {background-image="images/bg.jpg" background-opacity="0.5"}
...
## Future developments {.smaller .scrollable background-image="images/bg.jpg" background-opacity="0.5"}
...
## Discussion {background-image="images/bg.jpg" background-opacity="0.5"}

**Welcome to share your thoughts or suggestions!**

![](images/qa.gif){fig-align="center"}

## Reference {.smaller .scrollable background-image="images/bg.jpg" background-opacity="0.5"}
