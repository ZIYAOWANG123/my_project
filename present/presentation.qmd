...
The purpose of "Hexmap" package is to

### Motivation

Map illustration takes a vital role in exploratory data analysis as it not only provides the statistical information visualization but also adding the geographical information to allow insightful analysis based on a specific region or area. While map is delivering geographical and statistical information to help users for a better understanding of the data and facts, it sometimes can convey misleading information or conclusion. \[Example image: AEC example for electoral\].

Therefore, Hexmap is here to resolve this issue by reshaping the geographical area into multiple hexagons and allocating the statistics properly thus to conclude reasonable and proper inference. \[ABC news screenshots\] \[Image: show Emi's gif\]

###  \*Background Research \[This part may not be necessary - timing issue\]
...
Step 2- Map_grid - calculate the number of hexagons
