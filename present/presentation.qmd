...
## Step 3 - Allocating statistical information on hexagons {.smaller .scrollable}

::: incremental
-   Assigning the statistical information (can be set by the users), using an algorithm.
-   Current Stage - [AEC](https://results.aec.gov.au/27966/Website/HouseDownloadsMenu-27966-Csv.htm) data
...
-   Using [`geogrid`](https://github.com/jbaileyh/geogrid) functions
...
::: incremental
-   Improving the "Hungarian Algorithm" to enhance allocation accuracy and process. \[[**Currently testing**]{.underline}\]
-   Or, testing alternative algorithms which may be more effective and efficient such as the "[Genetic-algorithm](https://medium.com/sandstreamdev/the-genetic-algorithm-in-solving-the-quadratic-assignment-problem-9bde6ead47ab)" or published R packages like "[GA](http://luca-scr.github.io/GA/index.html)" .
