...
![2017 UK general election - `The Guardian`](images/paste-8924B4DD.png){fig-align="center" width="270"}
...
![](images/step3-choro.png){fig-align="center" width="545"}
:::

::: {.column width="50%"}
-   Allocation of statistical values on a **distorted cartogram**

![](images/step3-distort.png){fig-align="center" width="530" height="331"}
:::
:::
...
::: columns
::: {.column width="50%"}
![](images/paste-0793C53E.png){fig-align="center" width="470"}
:::

::: {.column width="50%"}
![](images/paste-BFF8301B.png){fig-align="center" width="470"}
:::
:::
